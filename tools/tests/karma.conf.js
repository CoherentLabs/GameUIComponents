...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      'text-field/*.js',
      'accordion-menu/*.js',
      'interaction-manager/draggable/*.js',
      'interaction-manager/resize/*.js',
      'interaction-manager/rotate/*.js',
      'interaction-manager/actions/*.js',
      'interaction-manager/keyboard/*.js',
      'interaction-manager/zoom/*.js',
      'interaction-manager/gamepad/*.js',
      'interaction-manager/dropzone/*.js',
    ],
    singleRun: true,
    retryLimit: 0,
    preprocessors: {
