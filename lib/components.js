    ...
    */
    ...
    class GamefaceComponents {
        ...
        */
         ...
         * @param {string} containerSelector - the selector of the parent element
         * @param {Array<HTMLElement>} children - the child elements that need to go into the parent
         */
        simpleRender(element, containerSelector, children) {
            const templateRoot = document.createElement('div');
            templateRoot.appendChild(element.template);
            const container = templateRoot.querySelector(containerSelector);
