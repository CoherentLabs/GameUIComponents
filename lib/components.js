    ...
    class GamefaceComponents {
        ...
        */
        resolveWithTemplate(component) {
            return new Promise((resolve) => {
                resolve([component.template.cloneNode(true), component.url]);
            });
        }
       ...
       loadResource(component) {
        if (component.template) {
            ...
            return new Promise((resolve) => {
                resolve([element.firstChild.cloneNode(true), component.url]);
            });
        }
        ...
        if (window.__optimize) {
            ...
            return new Promise((resolve) => {
                resolve([element.cloneNode(true), component.url]);
            });
        }
            ...
            const promise = new Promise(function (resolve, reject) {
                request.onload = (response) => {
                    if (request.status == 200) {
                        ...
                        resolve([tempEl.firstChild.cloneNode(true), url]);
                    } else {
                        reject(response);
                    }
                };
        ...
        */
        findSlots(parent, result = {}) {
            ...
            for (let i = 0; i < length; ++i) {
                ...
                } else if (childTagName !== GF_COMPONENT_SLOT_TAG_NAME && this.definedElements[childTagName] !== 'undefined') {
        ...
        * @returns {boolean} - true if the element was rendered, false if not
        */
        render(element) {
