...
const components = function () {
    ...
    class NativeElementValidator {
        ...
        tooLong() {
            ...
            return this.element.value.length > parseFloat(maxLength);
        }
        ...
        tooShort() {
            ...
            return this.element.value.length < parseFloat(minLength);
        }
        ...
        */
        rangeOverflow() {
            ...
            if (!max) return false;
            return parseFloat(this.element.value) > parseFloat(max);
        }
        ...
        */
        rangeUnderflow() {
            ...
            if (!min) return false;
            return parseFloat(this.element.value) < parseFloat(min);
        }
