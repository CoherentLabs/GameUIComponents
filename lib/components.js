...
const Components = function () {
    ...
    class GamefaceComponents {
        ...
        */
        renderOnce(element, templateID) {
            if (element.isRendered) return false;

            this.render(element, templateID);
        ...
        * @param {string} templateId
        */
        render(element, templateId) {
            let templateRoot;
            if (templateId) {
                // console.log('--------------------Using template tag:');
                templateRoot = document.getElementById(templateId).content.cloneNode(true);
            } else {
         ...
         * @param {string} templateId
         */
        transferChildren(element, targetContainerSelector, children, templateId) {
            let templateRoot;
            if (templateId) {
                console.log('--------------------Using template tag: ', templateId);
                templateRoot = document.getElementById(templateId).cloneNode(true);
            } else {
