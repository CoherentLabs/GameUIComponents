...
class Validator {
    ...
    /**
     * Check if element value is bigger than element max
     * @param {HTMLElement} element
     * @returns {boolean}
     */
    ...
    /**
     * Check if element value is less element max
     * @param {HTMLElement} element
     * @returns {boolean}
     */
     static tooShort(element) {
        const min = parseFloat(element.getAttribute('max'));
        return element.value > min;
    }

    /**
     * Check if element value is missing
     * @param {HTMLElement} element
     * @returns {boolean}
     */
...
class NativeElementValidator {
    ...
    tooLong() {
        return Validator.tooLong(this.element);
    }

    tooShort() {
        return Validator.tooShort(this.element);
    }
