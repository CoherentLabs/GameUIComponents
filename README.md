...
|copyrights:check      |Will check the files inside the *components* folder for copyright notice.    |N/A|`npm run copyrights:check`|
|copyrights:add        |Will add copyright notice to files inside the *components* folder that are missing it. |N/A|`npm run copyrights:add`|
